...
%descripcion: dada la lista de asignaturas aprobadas y la asignatura a aprobar la funcion busca las asignaturas que se van a desbloquear para poder ser tomadas gracias a la aprobacion de la asignatura nueva, osea el parametro 2
